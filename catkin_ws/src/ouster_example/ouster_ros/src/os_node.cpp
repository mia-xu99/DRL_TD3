...
#include "ouster_ros/OSConfigSrvWrite.h"
#include "ouster_ros/PacketMsg.h"
#include "ouster_ros/ros.h"

using PacketMsg = ouster_ros::PacketMsg;
using OSConfigSrv = ouster_ros::OSConfigSrv;
using OSConfigSrvWrite = ouster_ros::OSConfigSrvWrite;
...
int main(int argc, char** argv) {
    ...
    auto srv_write = nh.advertiseService<OSConfigSrvWrite::Request, OSConfigSrvWrite::Response>(
    "os_config_write", [&](OSConfigSrvWrite::Request& req, OSConfigSrvWrite::Response& res) {
        if (req.metadata.size()) {
            published_metadata = req.metadata;
            res.res = true;
            return true;
        }
        return false;
