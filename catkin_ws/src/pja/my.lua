...
options = {
  ...
  --published_frame = "odom",
  publisher_frame = "bse_footprint",
  odom_frame = "odom_sensor",
...
-- TRAJECTORY_BUILDER_2D.voxel_size = 0.1
TRAJECTORY_BUILDER_2D.num_accumulated_range_data = 1
TRAJECTORY_BUILDER_2D.min_range = 0.1
TRAJECTORY_BUILDER_2D.max_range = 8
TRAJECTORY_BUILDER_2D.min_z= 0.3
TRAJECTORY_BUILDER_2D.max_z= 1.15
TRAJECTORY_BUILDER_2D.missing_data_ray_length = 7
TRAJECTORY_BUILDER_2D.use_imu_data = false --暂时不用陀螺仪的数据
